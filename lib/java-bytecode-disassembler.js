    ...
    this.subscriptions = new CompositeDisposable(
      ...
      atom.workspace.addOpener(
        function(uri) {
          ...
          // If it ends with force-tac-method,
          // then it's a method opened from a classes' disassembled-view
          if (uri.endsWith("?force-tac-method")) {
            return tac.processFile(uri.replace("?force-tac-method", ""));
          }
      ...
      atom.commands.add(
        'atom-workspace', {
          ...
          'java-tac:process-method': function(e) {
            ...
            atom.workspace.open(dir + "?method-name" + method + "?force-tac-method");
          }
        }),
