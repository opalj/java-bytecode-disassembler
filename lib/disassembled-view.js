  ...
  loadFinalContent(htmlContent) {
    ...
    $(this.element).find(
      ...
      function(index, element) {
        ...
        liNestedField.style.fontSize = "small";
    ...
    spanMethods.style.fontSize = "medium";
    ...
    $(this.element).find(
      ...
      function(index, element) {
        ...
        liNestedMethod.style.fontSize = "small";
