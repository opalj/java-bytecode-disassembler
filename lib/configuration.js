...
export default
{
	config: {
		...
		disassemblerTimeout:{
			title: 'Disassembler Timeout',
			description: 'The time-limit (in ms) after starting to disassemble a file before the process is killed. (0 = no limit)',
			type: 'number',
			default: 0
		},
		stdoutMaxBuffer:{
			title: 'Disassembler Max-Buffer',
			description: 'The largest amount of data in kilobytes allowed to be generated by the disassembler for a single disassembled-view',
			type: 'number',
			default: 16000
		}
	}
